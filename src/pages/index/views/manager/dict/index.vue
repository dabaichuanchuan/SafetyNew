<template>
  <div class="app-container">
    <el-row type="flex">
      <el-col :span="6">
        <el-card class="table-container" shadow="hover">
          ...
          <div class="table-area">
            <el-input v-model="filterText" placeholder="输⼊关键字进⾏搜索" clearable />
            <el-tree ref="refTree" :data="data" :props="defaultProps" node-key="id" default-expand-all
              :expand-on-click-node="false" :filter-node-method="filterNode" accordion style="margin-top: 10px;">
              <template #default="{ node, data }">
                <span class="custom-tree-node">
                  <el-button size="mini" type="text" @click="bindSearchList(data.id)">{{ node.label }}</el-button>
                  <span>
                    <template v-if="node.level === 1">
                      <el-button size="mini" type="text" @click="bindCreate(data)">添加类型</el-button>
                    </template>
                    <template v-else>
                      <el-button size="mini" type="text" @click="bindCreateData(data)">添加数据</el-button>
                    </template>
                    <template v-if="node.level !== 1">
                      <el-divider direction="vertical" />
                      <el-button size="mini" type="text" @click="bindEdit(data)">编辑类型</el-button>
                    </template>
                  </span>
                </span>
              </template>
      ...
      <el-col :span="18">
        <el-card class="table-container" shadow="hover">
          ...
          <div class="table-area">
            <el-table ref="busTable" :data="list" size="small" v-loading="listLoading" border>
              ...
              <el-table-column label="操作" align="center" width="150">
                <template slot-scope="scope">
                  <el-button size="mini" type="text" @click="bindEditData(scope.row)">编辑</el-button>
                </template>
              </el-table-column>
            </el-table>
          </div>
    ...
    <el-dialog :title="dialogData.edit ? '编辑字典类型' : '添加字典类型'" :visible.sync="dialogData.show" width="50%">
        ...
        <el-row>
          <el-col :span="12">
            <el-form-item label="名称：" prop="name">
              <el-input v-model="dialogData.model.name" :maxlength="50" show-word-limit>
              </el-input>
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="编码：" prop="code">
              <el-input v-model="dialogData.model.code" :maxlength="50" show-word-limit>
              </el-input>
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="12">
            <el-form-item label="序号：" prop="seq">
              <el-input v-model="dialogData.model.seq" :maxlength="50" show-word-limit>
              </el-input>
            </el-form-item>
          </el-col>
          <el-col :span="12">
        ...
        <el-row>
          <el-col :span="24">
            <el-form-item label="描述：" prop="remark">
              <el-input v-model="dialogData.model.remark" :maxlength="225" show-word-limit>
              </el-input>
            </el-form-item>
          </el-col>
        </el-row>
    ...
    <el-dialog :title="dialogData1.edit ? '编辑字典数据' : '添加字典数据'" :visible.sync="dialogData1.show" width="50%">
      <el-form :model="dialogData1.model" ref="defaultDataForm" class="default-data-form" :rules="dialogData1.rules"
        label-width="105px" size="small">
        <el-row>
          <el-col :span="12">
            <el-form-item label="名称：" prop="name">
              <el-input v-model="dialogData1.model.name" :maxlength="50" show-word-limit>
              </el-input>
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="值：" prop="value">
              <el-input v-model="dialogData1.model.value" :maxlength="50" show-word-limit>
              </el-input>
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="12">
            <el-form-item label="序号：" prop="seq">
              <el-input v-model="dialogData1.model.seq" :maxlength="50" show-word-limit>
              </el-input>
            </el-form-item>
          </el-col>
          <el-col :span="12">
        ...
        <el-row>
          <el-col :span="12">
            <el-form-item label="属性1：" prop="property1">
              <el-input v-model="dialogData1.model.property1" :maxlength="50" show-word-limit>
              </el-input>
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="属性2：" prop="property2">
              <el-input v-model="dialogData1.model.property2" :maxlength="50" show-word-limit>
              </el-input>
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="24">
            <el-form-item label="描述：" prop="remark">
              <el-input v-model="dialogData1.model.remark" :maxlength="225" show-word-limit>
              </el-input>
            </el-form-item>
          </el-col>
        </el-row>
      ...
      <span slot="footer" class="dialog-footer">
        <el-button @click="dialogData1.show = false" size="small">取 消</el-button>
        <el-button type="primary" @click="bindDialogConfirmData()" :loading="dialogData1.saving" size="small">确 定
        </el-button>
      </span>
    </el-dialog>
  </div>
...
<script>
import { getDictTypeListForEnterprise, getDictDataPage, saveDictType, saveDictData } from '../../../api/dict'
