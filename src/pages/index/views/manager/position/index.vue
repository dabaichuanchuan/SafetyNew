  ...
  <div class="app-container">
        ...
        >
          ...
          <el-table-column label="级别" align="center">
            <template slot-scope="scope">{{
              scope.row.grade | formatOrgTypeEnumName
            }}</template>
          </el-table-column>
    ...
    >
      ...
      >
        ...
        <el-row>
          <el-col :span="12">
            <el-form-item label="业态：" prop="business">
              <el-select
                v-model="dialogData.model.business"
                clearable
                placeholder="请选择"
              >
                <el-option
...
export default {
    ...
    return {
      ...
      dialogData: {
        ...
        rules: {
          ...
          business: [{ required: true, message: "请选择业态" }],
          orderNo: [{ required: true, message: "请输入排序号" }],
          grade: [{ required: true, message: "请选择机构" }],
        },
      },
    };
  },
  ...
  filters: {
    ...
    formatOrgTypeEnumName(type) {
      return OrgTypeEnum.getName(type);
    },
  },
  methods: {
